...
<div class="card-action">
    <form action="{{ route('detail.updateStatus', ['id' => $forms->id]) }}" method="POST">
        @csrf
        @method('PUT')
    
        <button name="status_id" value="2" class="btn btn-success">Propose</button>
        <button name="status_id" value="3" class="btn btn-danger">Reject</button>
    </form>                    
</div>
@endsection
